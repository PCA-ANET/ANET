...
export default class CashTransfer {
  ...
  init = initRequest =>
    new Promise((resolver, reject) =>
      new AxiosAPI(true)
        .setUrl(Config.CashTransfer.STEP1)
        .setData(initRequest)
        .sendPost()
  ...
  validate = validationRequest =>
    new Promise((resolver, reject) =>
      new AxiosAPI(true)
        .setUrl(Config.CashTransfer.STEP2)
  ...
  resendOtp = resendOtpRequest =>
    new Promise((resolver, reject) =>
      new AxiosAPI(true)
        .setUrl(Config.CashTransfer.RESEND)
  ...
  getFavorites = () =>
    new Promise((resolver, reject) =>
      new AxiosAPI(true)
        .setUrl(Config.CashTransfer.FAVORITES)
  ...
  getHistory = () =>
    new Promise((resolver, reject) =>
      new AxiosAPI(true)
        .setUrl(Config.CashTransfer.HISTORY)
        .setContentType('application/x-www-form-urlencoded')
        .sendGet()
        .then(response => this._handleOnSuccess(response, resolver))
        .catch(error => this._handleOnError(error, reject)),
