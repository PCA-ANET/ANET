...
import { getHistoryTransfer } from '../../../redux/transfer/transfer.actions';
    ...
    return (
      <div className="row mx-auto">
        <div className="col-sm-12">
          <Panel title={t(`${HISTORY_NAMESPACE}transferHistoryPanelTitle`)}>
            <DataTable
              ...
              hover
              className="table-history-virement"
              data={tableData}
            />
          </Panel>
        </div>
...
const mapDispatchToProps = dispatch => ({
  getHistory: () => {
    dispatch(getHistoryTransfer());
  },
});

const mapStateToProps = state => ({
  history: state.Transfer.history,
});
